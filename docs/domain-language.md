...
| Resource             | A protected target identified by an exact HTTP or HTTPS audience URL, with a dashboard-managed name and scopes. It is the target of client access and consent.                                                                                                               |
